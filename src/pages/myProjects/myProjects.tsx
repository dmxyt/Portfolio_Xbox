...
function MyProjectsPage() {
    ...
    const btnFilterData = [
        ...
        {
            title: 'Typescript',
            numberOfProjects: projects.filter((p) => p.languages?.some(lang => lang.title === "Typescript")).length,
        },
        {
            title: 'React',
            numberOfProjects: projects.filter((p) => p.languages?.some(lang => lang.title === "React")).length,
        },
        {
            title: "Javascript",
            numberOfProjects: projects.filter((p) => p.languages?.some(lang => lang.title === "Javascript")).length,
        },
    ];
    return (
        <motion.div
