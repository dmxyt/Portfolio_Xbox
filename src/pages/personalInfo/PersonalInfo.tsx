...
export default function () {
    return (
        <>
            ...
            <main className="bg-primary bg-gradient pb-5 pt-5 
            text-white d-flex flex-column vh-100 overflow-auto">
                <Container fluid='md' className="d-flex wrap-competences-page 
