    ...
    return (
        <>
            ...
            <Offcanvas isOpen={isOpen} toggle={handleClose} className="offCanvas bg-black text-light">
                ...
                <hr />
                {/* </OffcanvasHeader> */}
                <OffcanvasBody className="px-4 pt-0">
                    <header className="title">
                        <h3>Contatos:</h3>
                        <h5>Quer enviar uma mensagem?</h5>
                    </header>
                    <form action="mailto:arthurgonsal@hotmail.com"
                        ...
                        <div className="message form-group d-flex flex-column gap-1">
                            ...
                            <textarea id="message"
                                ...
                                className="input form-control" rows={5} name="message"
                                required />
                        </div>
                    ...
                    <footer className="data-info">
                        ...
                        <div className="d-flex h1 gap-3 justify-content-between pt-2">
                            <a href="https://www.linkedin.com/in/arthur-gonçalves-saldanha-375a70157"
                                target="_blank">
                                <i className="bi bi-linkedin text-success"></i>
                            </a>
                            <a href="https://api.whatsapp.com/send?phone=11997354513"
                                target="_blank">
                                <i className="bi bi-whatsapp text-success"></i>
                            </a>
                            <a href="https://github.com/arthurgs2006"
                                target="_blank">
                                <i className="bi bi-github text-success"></i>
                            </a>
                            <a href="https://open.spotify.com/user/arthurgonsal123?si=bMwUo-3NQZ-XZFnVU10Agg"
                                target="_blank">
                                <i className="bi bi-spotify text-success"></i>
                            </a>
                            <a href="mailto:arthurgonsal@hotmail.com"
                                target="_blank">
